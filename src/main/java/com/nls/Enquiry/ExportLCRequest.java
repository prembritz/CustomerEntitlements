...
@Schema(name="ExportLCRequest",description="Request object with Unit Id and CIF")
@JsonbPropertyOrder({"proCode","unId","cif"})
public class ExportLCRequest {
	...
	@Schema(required =true , example="669319" , description = "Customer Id")
	@JsonbProperty("CIF")
	public String cif;
