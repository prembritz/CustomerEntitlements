...
public class CreditFacilitySummaryInterfaceDetails {
	...
	@APIResponseSchema(value = CreditFacilitySummaryInterfaceObject.class, responseDescription = "Credit Facility Summary Interface Details Response", responseCode = "200")
